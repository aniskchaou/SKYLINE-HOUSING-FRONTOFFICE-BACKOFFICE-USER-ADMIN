...
class __TwigTemplate_8eac7fa0f8aa7d5d8cafc64ce7b818ed8bb3e57ef39f04f100044a226ec34e6a extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "\">
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <input class='validate' value=\"admin\" type='text' name='_username' id='email' />
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <input class='validate' value=\"admin\" type='password' name='_password' id='password' />
